...
def receipt():
    ...
    if costoffoodvar.get() != '' or costofcakesvar.get() != '' or costofdrinksvar.get() != '':
        ...
        textReceipt.insert(END, f'Service Tax\t\t\t{30}Rs\n\n')
        textReceipt.insert(END,'***************************************************************\n')
        textReceipt.insert(END, f'Total Cost\t\t\t{subtotalofItems+30}Rs\n\n')
...
def totalcost():
    ...
    if var1.get() != 0 or var2.get() != 0 or var3.get() != 0 or var4.get() != 0 or var5.get() != 0 or \
        ...
        priceofDrinks=(item10*40)+(item11*30)+ (item12 * 80) + (item13 * 30) + (item14 * 40) + (item15 * 60) \
        ...
        servicetaxvar.set('30 Rs')

        tottalcost=subtotalofItems+30
...
root.title('Restaurant Management System created by Prasad Shinde')
...
buttonTotal=Button(buttonFrame,text='Total',font=('arial',15,'bold'),fg='white',bg='red4',bd=8.5,padx=6,
                   command=totalcost)
buttonTotal.grid(row=0,column=0)

buttonReceipt=Button(buttonFrame,text='Receipt',font=('arial',15,'bold'),fg='white',bg='red4',bd=8.5,padx=6
                     ,command=receipt)
buttonReceipt.grid(row=0,column=1)

buttonSave=Button(buttonFrame,text='Save',font=('arial',15,'bold'),fg='white',bg='red4',bd=8.5,padx=6
                  ,command=save)
buttonSave.grid(row=0,column=2)

buttonReset=Button(buttonFrame,text='Reset',font=('arial',15,'bold'),fg='white',bg='red4',bd=8.5,padx=6,
                   command=reset)
